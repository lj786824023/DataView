...
CREATE DEFINER="cq_sjpt"@"%" PROCEDURE "pr_f5_t88_ibank_cap_biz_info"(
...
/**********************************
 * LJZ 20210728 新建
 * LJZ 20230410 修改 累计及上日账户
 * 同业资金业务信息
 *********************************/
	
	DECLARE ETL_T_TAB_ENG_NAME 		VARCHAR(100)	DEFAULT 't88_ibank_cap_biz_info';
	...
	SET @SQL_STR = '
	INSERT INTO VT_t88_ibank_cap_biz_info(
		Statt_Dt               ,-- 1统计日期
		Agmt_ID                ,-- 2协议编号
		Cur_Cd                 ,-- 3币种代码
		Org_ID                 ,-- 4机构编号
	...
	-- 插入到AT表
	SET @SQL_STR = '
	INSERT INTO VT_AT_t88_ibank_cap_biz_info
	SELECT 
		${TX_DATE},-- 1 统计日期
	...
	FROM VT_t88_ibank_cap_biz_info T
	FULL JOIN VT_PRE_t88_ibank_cap_biz_info T1
