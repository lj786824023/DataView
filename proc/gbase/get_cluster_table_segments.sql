...
CREATE DEFINER="gbase"@"%" PROCEDURE "get_cluster_table_segments"(
...
BEGIN 
	...
	WHILE ETL_TAB_COUNT <> 0 DO
		...
		INSERT INTO ETL.cluster_table_segments
		SELECT * FROM INFORMATION_SCHEMA.cluster_table_segments where table_schema = ETL_DB_NAME and TABLE_NAME = ETL_TAB_NAME;
