...
from PySide6.QtWidgets import QMainWindow, QFileDialog, QTableWidgetItem, QTableWidget, QWidget
from openpyxl.workbook import Workbook
from qfluentwidgets import InfoBar, InfoBarPosition, IndeterminateProgressRing, FluentIcon, ColorDialog, \
...
from MyThread import PoolThread, DBQueryThread
...
class MyMainWindow(QMainWindow):
    ...
    def connect_db(self):
        ...
        time.sleep(5)
        self.sql1 = self.thread_pool.get_connection()
        print(self.sql1)
    ...
    def execute_sql_body_1(self):
        ...
        if self.thread_sql_execute_1:
            self.thread_sql_execute_1.sql=sql
        else:
            self.thread_sql_execute_1 = DBQueryThread(self.thread_pool.get_connection(),
                                                  sql=sql,
                                                  row_max=row,
    ...
    def execute_sql_body_2(self):
        ...
        self.thread_sql_execute_2 = DBQueryThread(self.thread_pool.get_connection(),
                                                  sql=sql,
                                                  row_max=row,
    ...
    def execute_sql_body_3(self):
        ...
        self.thread_sql_execute_3 = DBQueryThread(self.thread_pool.get_connection(),
                                                  sql=sql,
                                                  row_max=row,
    ...
    def init_ui(self):
        ...
        data_dict_key = sorted(data_dict.keys())
        self.myUI.lswDB.addItems(data_dict_key)
        # 初始化数据库连接选择
        self.myUI.cbb_choose_db.clear()
        self.myUI.cbb_choose_db.addItems(sorted(data_dict.keys()))
    ...
    def set_tbw_current(self):
        ...
        # print("当前选中tbw：" + self.tbw_current.objectName())
    ...
    def test_db_connect(self):
        ...
        self.thread_test_pool.sign_err.connect(print)
